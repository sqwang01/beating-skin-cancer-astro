...
export const STEP3: StepDef = {
  ...
  screens: [
     ...
     * itself: the general, non-stage-specific treatment picture. */
    {
      ...
      doctorQuestions: [
        'What is my Breslow thickness, is my melanoma ulcerated, and what stage does that make it?',
        'What surgical margin are you recommending, and where will the procedure be done?',
        'Do you recommend a sentinel lymph node biopsy in my case?',
        'Will I need any imaging, or a referral to a medical oncologist?',
      ],
    ...
    /* ---------------------------------------------------- STAGE SCREENS */
    {
      ...
      body: [
        'For melanoma in situ, treatment is usually a single procedure: surgically removing the area where the melanoma was found, along with a margin of normal-looking skin around it. Guidelines describe a standard surgical margin of about <strong>0.5 to 1 cm</strong> — “standard surgical margin” meaning the amount of normal surrounding skin taken with the melanoma. Your surgeon confirms the margin from the size and location of the melanoma and what the pathology showed.',
        ...
        'Surgery is not always the right fit — most often for a subtype of melanoma in situ called <strong>lentigo maligna</strong>. It can be too large to remove completely, the first surgery can come back with melanoma still at the edge, or a person’s overall health can make an operation inadvisable. In those situations a care team may discuss a skin cream called <strong>imiquimod (Aldara)</strong>, which prompts the immune system to attack the abnormal cells; it is not FDA-approved for this use, though studies have reported high rates of clearance and low recurrence. <strong>Radiation</strong> to the area is another option a team may raise.',
        CONFIRM_LINE,
      ],
      continueLabel: FINISH_LABEL,
      continueEvent: FINISH_EVENT,
    ...
    },
    {
      ...
      body: [
        ...
        'A <strong>sentinel lymph node biopsy</strong> (a procedure that samples the first lymph node the area drains to) is often not recommended at this stage. Some surgeons do discuss it when certain features are present — for example a Breslow thickness close to 0.8 mm, a biopsy that was cut off at its deep edge so the true thickness isn’t certain, or a high number of dividing (mitotic) cells. Ask your team whether any of these apply to you.',
      ...
      doctorQuestions: [
        'What surgical margin are you recommending, and will it be done under local or general anesthesia?',
        'Do any features of my melanoma — thickness near 0.8 mm, a truncated biopsy, the mitotic rate — make a sentinel lymph node biopsy worth considering?',
        'Is any imaging or follow-up testing needed, or is examining my skin and lymph nodes enough?',
      ],
      printLabel: 'Print these questions',
      continueLabel: FINISH_LABEL,
      continueEvent: FINISH_EVENT,
    ...
    },
    {
      ...
      doctorQuestions: [
        'Are you recommending a sentinel lymph node biopsy, and what would a positive or a negative result mean for my plan?',
        'What surgical margin are you planning?',
    ...
    },
    {
      ...
      body: [
        'For a melanoma in the Stage IIA range, treatment is a <strong>wider excision</strong>. Guidelines describe a standard surgical margin of about <strong>1 to 2 cm</strong> for a melanoma up to 2 mm thick and <strong>2 cm or more</strong> for a melanoma between 2 and 4 mm thick. Your surgeon confirms the exact margin.',
        'A <strong>sentinel lymph node biopsy</strong> is discussed and offered, usually at the same time as the wider excision.',
        'Routine imaging and blood tests are usually not recommended at this stage, and additional drug treatments are generally not part of the plan unless the lymph node result or other findings change the picture. Your care team confirms what applies to you.',
        CONFIRM_LINE,
      ],
      doctorQuestions: [
        'What surgical margin are you planning for my Breslow thickness?',
        'Are you recommending a sentinel lymph node biopsy, and what would the result change?',
        'Is any imaging needed now, and what follow-up schedule do you recommend?',
      ],
      printLabel: 'Print these questions',
      continueLabel: FINISH_LABEL,
      continueEvent: FINISH_EVENT,
    ...
    },
    {
      ...
      body: [
        'For a melanoma in the Stage IIB range, treatment is a <strong>wider excision</strong>. Guidelines describe a standard surgical margin of about <strong>1 to 2 cm</strong>, and <strong>2 cm or more</strong> for the thickest melanomas in this range. Your surgeon confirms the exact margin.',
        'A <strong>sentinel lymph node biopsy</strong> is discussed and offered, usually at the same time as the wider excision.',
        'Routine imaging and blood tests are generally not recommended at this stage. In some cases the <strong>medical oncologists</strong> on your team may discuss <strong>adjuvant treatment</strong> — drug treatment given after surgery to lower the chance the melanoma comes back. Your care team confirms whether this applies to you.',
        CONFIRM_LINE,
      ],
      doctorQuestions: [
        'What surgical margin are you planning for my Breslow thickness?',
        'Are you recommending a sentinel lymph node biopsy?',
        'Would you recommend I see a medical oncologist to discuss adjuvant treatment, and what would it involve?',
      ],
      printLabel: 'Print these questions',
      continueLabel: FINISH_LABEL,
      continueEvent: FINISH_EVENT,
    ...
    },
    {
      ...
      body: [
        ...
        'At this stage, <strong>imaging</strong> (such as CT or PET scans) or blood tests may be recommended as part of the workup. The <strong>medical oncologists</strong> on your team may also discuss <strong>adjuvant treatment</strong> — drug treatment after surgery aimed at lowering the chance of recurrence. Your care team confirms what applies to you.',
        CONFIRM_LINE,
      ],
      doctorQuestions: [
        'What surgical margin are you planning?',
        'Which scans or blood tests do you recommend, and how often?',
        'Would you recommend I see a medical oncologist to discuss adjuvant treatment, and what would it involve?',
      ],
      printLabel: 'Print these questions',
      continueLabel: FINISH_LABEL,
